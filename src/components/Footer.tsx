    ...
    <footer className="w-full bg-[#0a0a0a] border-t border-white/[0.08] text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-5 lg:col-span-1">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-white font-black tracking-widest text-[13px] leading-tight">
                DCCC CULTURAL
              </span>
              <span className="text-[#C8963E] font-bold tracking-widest text-[11px] leading-none">
                FIESTA 2026
              </span>
            </div>
          </div>
          <p className="text-white/40 text-xs leading-relaxed max-w-[220px]">
            Dhaka College Cultural Club — celebrating the spirit of Bangladeshi
            art, music, and heritage since 2021.
          </p>
          {/* Social icons */}
        ...
        <div className="flex flex-col gap-4">
          <p className="text-[10px] font-black tracking-[0.3em] text-[#C8963E] uppercase mb-1">
            Quick Links
          </p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-start gap-2.5">
              <svg
                className="w-3.5 h-3.5 mt-0.5 text-[#C8963E] shrink-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                strokeWidth="2"
            ...
            <div className="flex items-center gap-2.5">
              <svg
                className="w-3.5 h-3.5 text-[#C8963E] shrink-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                strokeWidth="2"
              ...
              <a
                href="mailto:dcccultural@dhakacollege.edu.bd"
                className="text-white/50 text-xs font-semibold hover:text-white transition-colors"
              >
      ...
      {/* Bottom bar */}
      <div className="border-t border-white/[0.06] py-5 px-4 pb-[max(1.25rem,env(safe-area-inset-bottom))]">
        <div className="max-w-6xl mx-auto flex flex-col items-center justify-center gap-3 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
          <p className="text-white/45 text-[11px] sm:text-[10px] tracking-wide leading-relaxed">
            © 2026 Dhaka College Cultural Club (DCCC) - All Rights Reserved.
          </p>
          <p className="text-white/70 text-xs sm:text-[10px] shrink-0 sm:text-right">
            Developed by{"   "}
            <a
              href="https://samiul.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#C8963E] hover:text-white transition-colors font-semibold underline underline-offset-2 decoration-[#C8963E]/40 pl-1"
            >
              Md. Samiul Islam
            </a>
          </p>
